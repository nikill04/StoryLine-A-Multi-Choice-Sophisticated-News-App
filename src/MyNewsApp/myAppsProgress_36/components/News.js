...
export class News extends Component {
    ...
    async updateNews() {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=ca3c90f1bfb44990a5d20bc11aaeeef1&page=${this.state.page}&pageSize=${this.props.pageSize}`
    ...
    fetchMoreData = async () => {
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=ca3c90f1bfb44990a5d20bc11aaeeef1&page=${nextPage}&pageSize=${this.props.pageSize}`
        let data = await fetch(url);
        let parsedData = await data.json()
        this.setState({
